...
;;
;; Guix package definition for rescript-dom-mounter
;;
;; Usage:
;;   guix shell -D -f guix.scm    # Enter development shell
;;   guix build -f guix.scm       # Build package
;;
;; TODO: Replace rescript-dom-mounter and customize inputs for your language/stack.
...
(package
  ...
  (home-page "https://github.com/hyperpolymath/rescript-dom-mounter")
  (synopsis "rescript-dom-mounter")
