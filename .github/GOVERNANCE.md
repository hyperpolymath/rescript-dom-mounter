...
This document describes the governance model for **rescript-dom-mounter**.

---

## Project Governance Model

rescript-dom-mounter follows a **Benevolent Dictator For Life (BDFL)** governance model.
