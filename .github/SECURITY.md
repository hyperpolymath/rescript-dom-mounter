...
Replace all {{PLACEHOLDER}} values with your information:
  rescript-dom-mounter     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  rescript-dom-mounter             - Repository name
...
- This repository (`hyperpolymath/rescript-dom-mounter`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/rescript-dom-mounter/security/advisories)
...
When using rescript-dom-mounter, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/rescript-dom-mounter/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/rescript-dom-mounter/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/rescript-dom-mounter/discussions) |
...
*Thank you for helping keep rescript-dom-mounter and its users safe.* 🛡️
