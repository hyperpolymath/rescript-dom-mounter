...
// Replace rescript-dom-mounter, Rescript Dom Mounter — See README.adoc for details., just run, Rescript Dom Mounter started successfully. with actuals
= rescript-dom-mounter — Quick Start for Users
:toc:
:toclevels: 2

== What is rescript-dom-mounter?

Rescript Dom Mounter — See README.adoc for details.
...
----
# Clone and set up
git clone https://github.com/hyperpolymath/rescript-dom-mounter.git
...
[source,bash]
----
just install --portable --prefix=./rescript-dom-mounter-portable
----
...
[source]
----
Rescript Dom Mounter started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/rescript-dom-mounter/wiki
