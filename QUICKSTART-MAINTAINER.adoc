...
// Replace rescript-dom-mounter, {{PACKAGE_NAME}}, {{DEPS}} with actuals
= rescript-dom-mounter — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining rescript-dom-mounter for
...
podman build -t rescript-dom-mounter .
----
...
* Upstream: https://github.com/hyperpolymath/rescript-dom-mounter/issues
